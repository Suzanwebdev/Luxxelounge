...
export const STOREFRONT_PRODUCT_ROW_SELECT =
  "id,slug,name,regular_price,sale_price,rating,total_reviews,stock_qty,tags,metadata,description,categories(name),product_images(image_url,sort_order)" as const;
